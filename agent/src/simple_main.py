...
app = FastAPI(
    title="TutorNestAI Agent - Simple Version",
...
async def generate_explanation(
    ...
    try:
        ...
        explanation += "This is a sample explanation generated by the TutorNestAI agent. In a full implementation, this would provide detailed step-by-step reasoning."
